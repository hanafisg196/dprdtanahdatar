...
class MemberController extends Controller
{
    ...
    public function createParty(Request $request)
    {
        ...
        return redirect()->route('dashboard.party.list')->with('success', 'Partai berhasil ditambahkan');
    }
    ...
    {
        $this->memberService->updateMember($request, $id);
        return redirect()->route('dashboard.member.list')->with('success', 'Anggota berhasil di perbarui');
    }
    ...
    public function getMemberDatailBySlug($slug)
    {
        $memberDetail = $this->memberService->getDetailMemberBySlug($slug);
