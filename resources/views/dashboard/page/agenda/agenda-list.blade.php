            ...
            <div class="{{ count($data) == 1 ? 'col-xl-8' : 'col-xl-4 col-md-6 col-sm-12' }}">
                <div class="card position-relative">
                    <div class="card-content">
                        ...
                        <img src="{{asset('dist/assets/compiled/jpg/agenda.jpg')}}" class="card-img-top img-fluid" alt="singleminded">
                        <div class="floating-buttons-action">
                            <a href="{{ route('dashboard.agenda.show', encrypt($item->id)) }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="card-body">
                            ...
                            <form id="{{ encrypt($item->id)}}" action="{{ route('dashboard.agenda.delete', encrypt($item->id)) }}" method="POST">
                                @csrf
