...
@section('content')
    ...
    <section class="section">
        <form action="{{ route('dashboard.member.update', $member->id) }}" method="post" id="form"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="flexRadioStatusNo"
                                            value="anggota"
                                            {{ old('status', $member->status) == 'anggota' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="flexRadioStatusYes" value="ketua"
                                            {{ old('status', $member->status) == 'ketua' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="flexRadioStatusYes" value="wakil ketua"
                                            {{ old('status', $member->status) == 'wakil ketua' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexRadioStatusYes">
                                            Wakil Ketua
                                        </label>
                                    </div>
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    ...
                                    @else
                                        <img src="{{ asset('/dist/assets/compiled/png/placeholder_member.png') }}"
                                            alt="Profile" width="200px;" height="250px;" style=" object-fit: cover;">
                                    @endif
                                </div>
