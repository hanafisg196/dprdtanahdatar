...
<form action="{{route('dashboard.article.update', $data->id)}}" method="post" id="form" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text"class="form-control my-editor @error('judul') is-invalid @enderror" id="judul" value="{{ $data->title }}"
                            ...
                            <div class="form-group">
                                <label for="judul">Oleh</label>
                                <small class="form-text text-danger">
                                    <i class="fas fa-info-circle"></i>
                                        *
                                </small>
                                <input type="text" class="form-control @error('oleh') is-invalid @enderror"
                                    id="oleh" name="oleh" value="{{ $data->author }}">
                                @error('judul')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
