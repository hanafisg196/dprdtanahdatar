<div class="modal fade" id="modal-addSubMenu-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle-1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable " role="document">
        <form action="{{ route('dashboard.settings.submenu.create', $item->id) }}" method="post" id="form">
            @csrf
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('subnama') is-invalid @enderror" id="subnama"
                        name="subnama" placeholder="Nama sub menu" value="{{ old('subnama') }}">
                    @error('subnama')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('sublink') is-invalid @enderror"
                        name="sublink" placeholder="https://" value="{{ old('sublink') }}">
                    @error('sublink')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
