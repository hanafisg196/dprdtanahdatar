...
<html>
	<head>
		...
		<title>Selamat Datang Di Tanah Datar</title>
	...
	<body>
      ...
      html,.body{
        ...
        .tp-caption {
            position: relative;
            overflow: hidden; /* Pastikan efek border terlihat */
        ...
        .tp-caption:hover i {
            transform: scale(1.3); /* Perbesar ikon */
            color: #fff; /* Ubah warna ikon */
        }
		...
		<div class="pageWrapper">
			...
			<!-- Header start -->
			<header class="top-head semi light transparent fixed-head full">
		    	<div class="container">
			    	<!-- Logo start -->
			    	<div class="logo">
									...
									<ul>
										...
										<li><a href="#">Blog Single</a>
											<ul>
												...
												<li><a href="blog-comments-facebook.html">Facebook Comments</a></li>
												<li><a href="blog-comments-disqus.html">Disqus Comments</a></li>
											</ul>
										</li>
                ...
                <div id="rev_slider_4_1" class="rev_slider fullscreenbanner" data-version="5.0">
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="1500" data-saveperformance="off">
                            <video autoplay muted loop preload="auto" style="width: 100%; height: 100%; object-fit: cover;">
                                <source src="assets/images/videos/hands.mp4" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                            <!-- LAYERS -->

                            <!-- LAYER NR. 1 -->
                            <h4 class="tp-caption uppercase tp-resizeme captionTextOne"
                               id="captionTextOne"
                                data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                data-y="['top','top','top','top']" data-voffset="['120','120','260','200']"
                                data-fontsize="['50','50','15','15']"
                                ...
                                style="z-index: 8; white-space: nowrap;">Pemerintah Kabupaten<span class="main-color"> Tanah Datar</span> </h4>

                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption uppercase tp-resizeme t-center"
                                id="captionTextTwo"
                                data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                data-y="['top','top','top','top']" data-voffset="['260','180','250','180']"
                                ...
                                data-responsive_offset="on"
                                style="z-index: 14;">
                                Tuah Sakato, &nbsp; Adat Mamakai
                            </div>
                            <!-- LAYER NR. 3 -->
                             <a class="tp-caption t-center main-bg border5px"
                                 id="captionOne"
                                 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                 data-y="['top','top','top','top']" data-voffset="['350','280','350','280']"
                                 data-width="['100','100','80','80']"
                                 data-height="['80','80','60','60']"
                                 data-fontsize="['20','20','10','10']"
                                 data-lineheight="['50','50','30','30']"
                                 data-whitespace="nowrap"
                                 data-transform_idle="o:1;"
                                 data-transform_in="opacity:0;sX:0;sY:0;s:1000;e:Power2.easeInOut;"
                                 data-transform_out="opacity:0;sX:0;sY:0;s:1000;e:Power3.easeIn;s:300;e:Power3.easeIn;"
                                 data-start="2100"
                                 data-splitin="none"
                                 data-splitout="none"
                                 data-responsive_offset="on"
                                 data-responsive="off"
                                 id="popover1"
                                 style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                 flex-direction: column;
                                 text-align: center;
                                 background-color: rgba(0, 0, 0, 0.75);
                                 color: #fff;">
                                 <i class="fa fa-home" style="font-size: 40px; margin-bottom: 5px;"></i>
                                 <span style="font-size: 10px;line-height: 1;display: block;">
                                   PELUK TANDA DIRI
                                 </span>
                                </a>

                            <!-- LAYER NR. 4 -->
                               <button class="tp-caption t-center main-bg border5px"
                                id="captionInvestasi"
                                data-x="['center','center','center','center']" data-hoffset="['50','50','0','0']"
                                data-y="['middle','middle','middle','middle']" data-voffset="['100','100','40','40']"
                                data-width="['80','80','60','60']"
                                data-height="['80','80','60','60']"
                                data-fontsize="['20','20','10','10']"
                                data-lineheight="['50','50','30','30']"
                                data-whitespace="nowrap"
                                ...
                                data-splitout="none"
                                data-toggle="modal"
                                data-target=".bs-example-investasi-sm"
                                data-responsive_offset="on"
                                data-responsive="off"
                                style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                    flex-direction: column;
                                    ...
                                    color: #fff;
                                ">
                                <i class="fa fa-line-chart" style="font-size: 40px; margin-bottom: 5px;"></i>
                                <span style="font-size: 10px; line-height: 1;">INVESTASI</span>
                                </button>
                                ...
                                data-responsive="off"
                                data-toggle="modal"
                                data-target=".bs-example-ppid-sm"
                                style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                    flex-direction: column;
                                    text-align: center;
                                    background-color: rgba(0, 0, 0, 0.75);
                                    color: #fff;
                                ">
                                <i class="fa fa-book" style="font-size: 40px; margin-bottom: 5px;"></i>
                                <span style="font-size: 10px; line-height: 1;">PPID</span>
                              </button>
                            ...
                            <a class="tp-caption t-center main-bg border5px"
                             ...
                             data-responsive_offset="on"
                             data-responsive="off"
                             href="https://ipkd.tanahdatar.go.id/"
                              style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                flex-direction: column;
                                text-align: center;
                                background-color: rgba(0, 0, 0, 0.75);
                                color: #fff;
                              ">
                            <i class="fa fa-credit-card" style="font-size: 40px; margin-bottom: 5px;"></i>
                            <span style="font-size: 10px; line-height: 1;">IPKD</span>
                            </a>


                            <button class="tp-caption t-center main-bg border5px"
                            id="captionSpbe"
                            data-x="['center','center','center','center']" data-hoffset="['-50','-50','0','100']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['100','100','40','40']"
                            data-width="['80','80','60','60']"
                            data-height="['80','80','60','60']"
                            data-fontsize="['20','20','10','10']"
                            ...
                            data-splitout="none"
                            data-toggle="modal"
                            data-target=".bs-example-modal-spbe-lg"
                            data-responsive_offset="on"
                            data-responsive="off"
                            style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                flex-direction: column;
                                ...
                                color: #fff;
                            ">
                            <i class="fa fa-window-maximize" style="font-size: 40px; margin-bottom: 5px;"></i>
                            <span style="font-size: 10px; line-height: 1;">SPBE</span>
                            </button>

                            <button class="tp-caption t-center main-bg border5px"
                            id="captionData"
                            data-x="['center','center','center','left']" data-hoffset="['-160','-160','0','100']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['100','100','40','40']"
                            data-width="['80','80','60','60']"
                            data-height="['80','80','60','60']"
                            data-fontsize="['20','20','10','10']"
                            ...
                            data-responsive="off"
                            data-toggle="modal"
                            data-target=".bs-example-modal-data-sm"
                            {{-- data-toggle="popover" title="Informasi Data" data-placement="top"
                            data-content="
                            <div class='row'>
                                <div class='list-group'>
                                    <button type='button' class='list-group-item'><i class='fa fa-external-link' style='padding-right: 3px;'></i>Portal Satu Data</button>
                                    <button type='button' class='list-group-item'><i class='fa fa-external-link' style='padding-right: 3px;'></i>Jumlah Pelayanan Peserta KB Baru Berdasarkan Metode Kontrasepsi
                                        Kabupaten Tanah Datar (Rilis data bulanan setiap tanggal 15 di bulan berikutnya(Portal Satau Data))
                                    </button>
                                </div>
                            </div>
                             " --}}
                            style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                ...
                                color: #fff;
                            ">
                            <i class="fa fa-table" style="font-size: 40px; margin-bottom: 5px;"></i>
                            <span style="font-size: 10px; line-height: 1;">DATA</span>
                           </button>

                           <button class="tp-caption t-center main-bg border5px"
                            id="captionRadio"
                            data-x="['center','center','center','left']" data-hoffset="['-265','-265','0','100']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['100','100','40','40']"
                            data-width="['80','80','60','60']"
                            data-height="['80','80','60','60']"
                            data-fontsize="['20','20','10','10']"
                            ...
                            data-responsive="off"
                            data-toggle="modal"
                            data-target=".bs-example-modal-radio-sm"
                            {{-- data-toggle="popover" title="Informasi Radio" data-placement="top"
                            data-content="
                            <div class='list-group'>
                            <button type='button' class='list-group-item'><i class='fa fa-external-link' style='padding-right: 3px;'></i>Radio Luhak Nan Tuo</button>
                            </div>
                             " --}}
                            style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                flex-direction: column;
                                ...
                                color: #fff;
                                ">
                            <i class="fa fa-microphone" style="font-size: 40px; margin-bottom: 5px;"></i>
                            <span style="font-size: 10px; line-height: 1;">RADIO</span>
                           </button>


                             <!-- LAYER NR. 5 -->
                             <div class="tp-caption t-center main-bg border5px"
                             id="captionPengaduan"
                             data-x="['center','center','center','center']" data-hoffset="['50','50','0','0']"
                             data-y="['middle','middle','middle','middle']" data-voffset="['200','200','40','40']"
                             data-width="['80','80','60','60']"
                             data-height="['80','80','60','60']"
                             data-fontsize="['20','20','10','10']"
                             data-lineheight="['50','50','30','30']"
                             ...
                             data-responsive="off"
                             data-toggle="modal"
                             data-target=".bs-example-pengaduan-sm"
                             style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                 flex-direction: column;
                                 text-align: center;
                                 background-color: rgba(0, 0, 0, 0.75);
                                 color: #fff;
                             ">
                             <i class="fa fa-sticky-note" style="font-size: 40px; margin-bottom: 5px;"></i>
                             <span style="font-size: 10px; line-height: 1;">PENGADUAN</span>
                             </div>
                             ...
                             style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                                 ...
                                 color: #fff;
                             ">
                             <i class="fa fa-bookmark" style="font-size: 40px; margin-bottom: 5px;"></i>
                             <span style="font-size: 10px; line-height: 1;">TDA</span>
                             </div>
                         ...
                         <div class="tp-caption t-center main-bg border5px"
                          ...
                          data-responsive="off"
                          data-toggle="modal"
                          data-target=".bs-example-gender-sm"
                           style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                             flex-direction: column;
                             text-align: center;
                             background-color: rgba(0, 0, 0, 0.75);
                             color: #fff;
                           ">
                         <i class="fa fa-window-restore" style="font-size: 40px; margin-bottom: 5px;"></i>
                         <span style="font-size: 10px; line-height: 1;">GENDER</span>
                         </div>

                         <div class="tp-caption t-center main-bg border5px"
                         id="captionPendidikan"
                         data-x="['center','center','center','center']" data-hoffset="['-50','-50','0','100']"
                         data-y="['middle','middle','middle','middle']" data-voffset="['200','200','40','40']"
                         data-width="['80','80','60','60']"
                         data-height="['80','80','60','60']"
                         ...
                         data-responsive="off"
                         data-toggle="modal"
                         data-target=".bs-example-pendidikan-sm"
                         style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                             flex-direction: column;
                             text-align: center;
                             background-color: rgba(0, 0, 0, 0.75);
                             color: #fff;
                         ">
                         <i class="fa fa-graduation-cap" style="font-size: 40px; margin-bottom: 5px;"></i>
                         <span style="font-size: 10px; line-height: 1;">PENDIDIKAN</span>
                         </div>

                         <div class="tp-caption t-center main-bg border5px"
                         id="captionPariwisata"
                         data-x="['center','center','center','left']" data-hoffset="['-160','-160','0','100']"
                         data-y="['middle','middle','middle','middle']" data-voffset="['200','200','40','40']"
                         data-width="['80','80','60','60']"
                         data-height="['80','80','60','60']"
                         ...
                         data-responsive="off"
                         data-toggle="modal"
                         data-target=".bs-example-modal-pariwisata-lg"
                         style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                             flex-direction: column;
                             text-align: center;
                             background-color: rgba(0, 0, 0, 0.75);
                             color: #fff;
                         ">
                         <i class="fa fa-location-arrow" style="font-size: 40px; margin-bottom: 5px;"></i>
                         <span style="font-size: 10px; line-height: 1;">PARIWISATA</span>
                         </div>
                         ...
                         data-responsive="off"
                         data-toggle="modal"
                         data-target=".bs-example-siduri-sm"
                         style=" z-index: 13;display: flex; align-items: center;justify-content: center;
                             flex-direction: column;
                             text-align: center;
                             background-color: rgba(0, 0, 0, 0.75);
                             color: #fff;">
                         <i class="fa fa-hospital-o" style="font-size: 40px; margin-bottom: 5px;"></i>
                         <span style="font-size: 10px; line-height: 1;">SIDURI</span>
                         </div>
                        ...
                        <div class="tp-caption rev-btn "
                            id="captionMasuk"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['top','top','top','bottom']" data-voffset="['700','700','700','0']"
                            data-width="none"
                            data-height="none"
                            data-whitespace="nowrap"
                            data-transform_idle="o:1;"
                            ...
                            data-responsive_offset="on"
                            data-responsive="off"
                            style="z-index: 13; font-size: 20px; line-height: 50px; font-weight: 500;
                            padding:0 30px;border-radius:3px;">
                            <a class="btn btn-lg btn-icon-right no-bg main-bg" href="{{route('home')}}"><i class="fa fa-arrow-right"></i><span>MASUK WEBSITE</span></a>
                        </div>
	    	...
	    	<!-- Content start -->
            <!-- Modals -->
            @include('tanahdatar.page.landing-modals')
            <!-- Modals end -->


	    	<!-- Footer start -->
		    <footer id="footWrapper" class="fixed-footer hi-index">
			    <!-- footer bottom bar start -->
			    <div class="footer-bottom semi light">

		    		<!-- footer copyrights left cell -->
		    		<div class="copyrights col-md-5">© Copyrights <b class="main-color">Official Website Kabupaten Tanah Datar</b> 2025. All rights reserved.</div>
        ...
        <script>
        function adjustDataAttributesById() {
        const captionTextOne = document.querySelector('#captionTextOne');
        const captionTextTwo = document.querySelector('#captionTextTwo');
        const captionOne = document.querySelector('#captionOne');
        const captionSiduri = document.querySelector('#captionSiduri');
        const captionPariwisata = document.querySelector('#captionPariwisata');
        const captionData = document.querySelector('#captionData');
        const captionRadio = document.querySelector('#captionRadio');
        const captionGender = document.querySelector('#captionGender');
        const captionTda = document.querySelector('#captionTda');
        const captionPengaduan = document.querySelector('#captionPengaduan');
        const captionIpkd = document.querySelector('#captionIpkd');
        const captionInvestasi = document.querySelector('#captionInvestasi');
        const captionSpbe = document.querySelector('#captionSpbe');
        const captionPendidikan = document.querySelector('#captionPendidikan');
        const captionPpid = document.querySelector('#captionPpid');
        const captionMasuk = document.querySelector('#captionMasuk');


        if (window.innerWidth <= 500) {
            captionTextOne.setAttribute('data-y', '40');
            captionTextOne.setAttribute('data-fontsize', '25');
            captionTextTwo.setAttribute('data-fontsize', '15');
            captionTextTwo.setAttribute('data-y', '130');
            captionOne.setAttribute('data-y', '200');
            captionOne.setAttribute('data-fontsize', '6');
            captionSiduri.setAttribute('data-y', '600');
            captionSiduri.setAttribute('data-fontsize', '6');
            captionPariwisata.setAttribute('data-y', '500');
            captionPariwisata.setAttribute('data-fontsize', '6');
            captionData.setAttribute('data-y', '400');
            captionData.setAttribute('data-fontsize', '6');
            captionRadio.setAttribute('data-y', '300');
            captionRadio.setAttribute('data-fontsize', '6');
            captionGender.setAttribute('data-y', '600');
            captionGender.setAttribute('data-x', '305');
            captionGender.setAttribute('data-fontsize', '6');
            captionTda.setAttribute('data-y', '600');
            captionTda.setAttribute('data-fontsize', '6');
            captionPengaduan.setAttribute('data-y', '500');
            captionPengaduan.setAttribute('data-x', '305');
            captionPengaduan.setAttribute('data-fontsize', '6');
            captionInvestasi.setAttribute('data-y', '300');
            captionInvestasi.setAttribute('data-fontsize', '6');
            captionSpbe.setAttribute('data-y', '300');
            captionSpbe.setAttribute('data-fontsize', '6');
            captionPendidikan.setAttribute('data-y', '400');
            captionPendidikan.setAttribute('data-fontsize', '6');
            captionPpid.setAttribute('data-y', '400');
            captionPpid.setAttribute('data-fontsize', '6');
            captionMasuk.setAttribute('data-y', '720');
            captionMasuk.setAttribute('data-fontsize', '6');
            captionIpkd.setAttribute('data-y', '500');
            captionIpkd.setAttribute('data-fontsize', '6');
        ...
        //  }
        //  if (window.innerWidth <= 500) {
        //     captionMasuk.setAttribute('data-y', '750');
        //     captionMasuk.setAttribute('data-fontsize', '6');
        //  }
...
// Tambahkan event listener untuk mengamati perubahan ukuran layar
window.addEventListener('resize', adjustDataAttributesById);

// Panggil sekali saat halaman dimuat untuk memastikan atribut sesuai ukuran awal
adjustDataAttributesById();
